CREATE TABLE ecommerce.tb_seller_draft_prod_ecomm (
	...
	vlr_peso                         INT64     OPTIONS(description="Valor do peso do produto, indicado na embalagem"),
	...
	nome_tag_loja_seller             STRING    OPTIONS(description="Tag da loja do seller"),
	...
	sgl_empresa_integradora          STRING    OPTIONS(description="Sigla do prefixo da empresa integradora"),
	nome_empresa_integradora         STRING    OPTIONS(description="Nome da empresa integradora"),
	hash_empresa_integradora        STRING    OPTIONS(description="Hash referente ao token da empresa integradora"),
